...
class ConsultaLancamentos extends React.Component {
    ...
    deletar = () => {
        this.service.deletar(this.state.lancamentoDeletar.id).then(
            response => {
            ...
            error => messages.mensagemErro('Ocorreu um erro ao tentar deletar o Lançamento.')
        )        
    }
    ...
    render() {
        ...
        return (
            <Card title="Consulta Lançamentos">
                <div className="row">
                    <div className="col-md-6">
                        <div className="bs-component">
                            ...
                            <FormGroup htmlFor="inputMes" label="Tipo Lançamento: ">
                ...
                <div>                
                <Dialog header="Confirmação" visible={this.state.showConfirmDialog} style={{ width: '50vw' }} footer={confirmDialogFooter} modal={true} onHide={() => this.setState({showConfirmDialog: false})}>
